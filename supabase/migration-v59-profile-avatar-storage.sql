-- v59: Supabase Storage bucket for profile avatars
...
begin
  ...
  if not exists (
    ...
    where schemaname = 'storage'
      and tablename = 'objects'
      and policyname = 'Users can upload profile avatars'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'storage'
      and tablename = 'objects'
      and policyname = 'Users can update profile avatars'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'storage'
      and tablename = 'objects'
      and policyname = 'Users can delete profile avatars'
  ) then
