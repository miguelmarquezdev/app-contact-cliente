  ...
  return (
    <PageShell>
      <div className="mx-auto max-w-3xl">
        ...
        <form action={updateCollaboratorProfile} className="space-y-6 sm:space-y-7">
          ...
          <section className="space-y-3.5 sm:space-y-4">
            ...
            <input value={profile?.role === 'tour_leader' ? 'Tour Leader' : 'Colaborador'} className="profile-input bg-slate-50 text-slate-500" disabled />
            <input value={profile?.position || 'Puesto operativo'} className="profile-input bg-slate-50 text-slate-500" disabled />
          </section>
